...
<head>
  ...
  <script src="https://kit.fontawesome.com/663232cd03.js" crossorigin="anonymous"></script>
  <!-- JQuery -->
  ...
  <div class="form-wrapper">
    ...
    <div class="form-contents">
      ...
      <div class="form-line-contact">
        <div class="form-line-title"><img src="./images/Line-icon.svg" alt="">公式LINEでのお問い合わせ</div>
        ...
        <div class="form-line-link">
          <a href="#"><img src="./images/公式LINEはこちら.svg" alt=""></a>
        </div>
      </div>

      <!-- フォームでのお問い合わせ -->
      <div class="form-line-contact">
        <div class="form-line-title"><img src="./images/Mail-icon.svg" alt="">フォームでのお問い合わせ</div>
      ...
      <form class="form" action="https://form.run/api/v1/r/1g5ihaqer4ouruczzchjdgrv" method="post">
        ...
        <button type="submit" class="form-submit" data-formrun-error-text="未入力の項目があります"
          data-formrun-submitting-text="送信中...">確認画面へ進む</button>
      </form>
